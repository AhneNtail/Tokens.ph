<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $query = "SELECT passengerinfo.passengerName, passengerinfo.passengerId, bookinginfo.origin, bookinginfo.destination, bookinginfo.bookingDate, bookinginfo.passengercount, bookinginfo.amount, bookinginfo.serialNo
                 FROM passengerinfo
