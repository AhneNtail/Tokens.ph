...
<body>
	...
	?>
				...
				<div class="input_buttons">
					<button type="submit" id = "Submit" name = "Submit" formaction = "updateAccount.php">Save changes </button><br>
					<button type="submit" id= "delete" name = "delete" formaction = "deleteInfo.php">Delete Account</button>
				</div>
			</form>
		</div>
	</div>
